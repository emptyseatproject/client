...
/**
 * Created by Splendor on 2017-05-12.
 */
...
public class HttpUtilVersion extends AsyncTask<String,String,String>{
    private Context context;
    public HttpUtilVersion(Context context){
    ...
    protected void onPostExecute(String json) {
        ...
        try{
            ...
            ((MainActivity)context).parseVerAry(ary);
        }catch (Exception e){
            e.printStackTrace();
        }
        */
        ...
        try{
            ((IntroActivity)context).parseVerAry(json);
        }catch(Exception e){
            e.printStackTrace();
        }
    }
