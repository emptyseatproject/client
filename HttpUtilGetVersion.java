...
public class HttpUtilGetVersion extends AsyncTask<String,String,String> {
    private Context context;
    public HttpUtilGetVersion(Context context){
    ...
    protected void onPostExecute(String json) {
        ...
        try{
            ((IntroActivity)context).parseGetVerAry(json);
        }catch(Exception e){
            e.printStackTrace();
        }
    }
