...
public class HttpUtilBus extends AsyncTask<String,String,String>{

    // public String[] urlSplit;   // url에서 =M5422 '='이후 부분 M5422 추출용
    // public String busNo;    // 버스 번호 리턴용

    private Context context;
    public HttpUtilBus(Context context){
    ...
    protected String doInBackground(String... objects) {
        ...
        /*
        urlSplit = url.split("=");
        busNo = urlSplit[urlSplit.length-1];
        */
        try{
            URL obj = new URL(url);
    ...
    protected void onPostExecute(String json) {
        ...
        try{
            ...
            ((IntroActivity)context).parseStopAry(ary);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
